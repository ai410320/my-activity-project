        ...
        <div class="container">
            <div class="content-border">
                <div class="mt-1">
                    ...
                    <p class="text-white font-size-13px mt-3">凡在棋牌游艺中，7天累计有效投注达1万或以上即可领取周周彩金，最高可达<span class="text-danger">11137元！</span></p>
                </div>
                <div class="mt-4">
                        ...
                        <table class="text-c font-size-13px" width="100%">
                            <thead>
                                <tr class="height-px-40 text-brown">
                                    <th class="th-border-radius" width="33.3%">周有效投注</th>
                                    <th class="th-border-radius" width="33.3%">奖励金额</th>
                            ...
                            <tbody>
                                <tr class="table-bordered text-white">
                                    ...
                                    <td class="pd-1 table-bordered" rowspan="9">
                                        每周一 <br /><br />
                                        <span class="text-danger">08:00</span><br />
                                        <br />开放领取
                                    </td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">5万+</td>
                                    <td class="table-bordered">27</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">20万+</td>
                                    <td class="table-bordered">87</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">50万+</td>
                                    <td class="table-bordered">277</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">100万+</td>
                                    <td class="table-bordered">577</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">300万+</td>
                                    <td class="table-bordered">117</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">500万+</td>
                                    <td class="table-bordered">217</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">1000万+</td>
                                    <td class="table-bordered">5,137</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">2000万+</td>
                                    <td class="table-bordered">11,137</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="content-border mt-3">
                <div>
                    ...
                    <ul class="font-size-13px text-white mt-2">
                        <li style="list-style: disc !important">周一至周日为一周期，凡是在【棋牌游艺】周累计有效投注额达到对应等级，次周一即可在活动页面领取对应彩金;</li>
                        <li style="list-style: disc !important">所获得彩金只需<span class="text-danger">【3倍流水】</span>方可申请提款；</li>
                        <li style="list-style: disc !important">符合领取条件的会员请在次周一24小时内进行领取，逾期将无法领取该优惠;</li>
