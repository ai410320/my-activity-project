        ...
        <div class="container">
            <div class="content-border">
                <div class="mt-1">
                    ...
                    <p class="text-white font-size-13px mt-3">活动期间, 全体新会员<span class="text-yellow">【下载APP】</span>登录，第二次单笔存款<span class="text-yellow">100元以上</span>，即可获得最高<span class="text-yellow">1888元</span>存款回馈金，您还在等什么？快来告诉您的亲朋好友一起参与吧！</p>
                </div>
                <div class="mt-4">
                        ...
                        <table class="text-c font-size-13px" width="100%">
                            ...
                            <tbody>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered" rowspan="6">二存</td>
                                    <td class="table-bordered">≥100</td>
                                    <td class="table-bordered">18</td>
                                </tr>
                                <tr class="table-bordered text-white">
                                    <td class="table-bordered">≥300</td>
                ...
                <div class="mt-4">
                    <div>
                        <p class="text-white font-size-13px"><span class="text-danger">例：</span>新会员在第二笔存款5000元后，即可点击优惠页面申请二存彩金188元，流水188*6倍=1128元即可提现</p>
                    </div>
                </div>
                <!-- 按鈕 -->
            ...
            <div class="content-border mt-3">
                <div class="mt-1">
                    ...
                    <ol class="font-size-13px text-white mt-2">
                        <li>活动开始后，您注册后将自动参加。您需要在二次充值并达到充值金额要求。</li>
                        <li>仅一次机会，充值越多，奖励越多，最高可获得奖励1888.00元。</li>
                        <li>奖金仅支持用户2次<span class="text-yellow">存款次日前</span>手动点击领取，奖金将自动发放到钱包，逾期视为放弃。</li>
                        <li>
                            本次活动的所有奖金，需要彩金<span class="text-yellow"><span class="washTime">6倍</span>流水</span>才能提现。
                        </li>
