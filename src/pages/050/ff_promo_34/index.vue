        ...
        <div class="container">
            <div class="promo-content">
                ...
                <div class="table-box">
                    <table>
                        <thead>
                            <tr>
                                <th class="t-title"><b>当日充值金额</b></th>
                                <th class="t-title"><b>赠送彩金</b></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="t-content">≥50</td>
                ...
                <p><span class="text-warning fw-600">例：</span>新会员在第一笔存款1000元后，即可点击优惠页面申请首存彩金88元，流水88*<span class="washTime">3倍</span>=<span id="washTimeResult">264</span>元即可提现</p>
                <!-- CTA -->
            ...
            <div class="promo-content">
                ...
                <ol class="rules">
                    ...
                    <li>奖金仅支持用户首次<span class="text-warning fw-600">存款次日前</span>手动点击领取，奖金将自动发放到钱包，逾期视为放弃。</li>
                    <li>
...
onMounted(() => {
    console.log('ff_promo_34', props.msg)
