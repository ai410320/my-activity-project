        ...
        <div class="container">
            <div class="promo-content">
                ...
                <div class="table-box">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td class="t-content" rowspan="6">二存</td>
                                <td class="t-content">≥100</td>
                                <td class="t-content">18</td>
                            </tr>
                            <tr>
                                <td class="t-content">≥300</td>
                ...
                <p><span class="text-warning fw-600">例：</span>新会员在第二笔存款5000元后，即可点击优惠页面申请二存彩金188元，流水188*<span class="washTime">6倍</span>=<span id="washTimeResult">1128</span>元即可提现</p>
                <!-- CTA -->
            ...
            <div class="promo-content">
                ...
                <ol class="rules">
                    ...
                    <li>奖金仅支持用户2次<span class="text-warning fw-600">存款次日前</span>手动点击领取，奖金将自动发放到钱包，逾期视为放弃。</li>
                    <li>
                        本次活动的所有奖金，需要<span class="text-warning fw-600">彩金<span class="washTime">6倍</span>流水</span>才能提现。
                    </li>
...
onMounted(() => {
    console.log('ff_promo_35', props.msg)
