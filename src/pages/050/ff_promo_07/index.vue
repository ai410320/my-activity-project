    ...
    <div id="ui-promo-detail" class="outer">
        ...
        <div class="container">
            <div class="promo-content">
                ...
                <p><span class="text-highlight">活动内容：</span>活动期间，会员在【电子游艺厅】<span class="note-text">周负盈利</span>达到相应等级，即可<span class="note-text">获得相应救援金</span>。</p>
                <div class="table-box">
                    <table>
                        <thead>
                            <tr>
                                <th class="t-title" width="20%"><b>阶梯</b></th>
                                <th class="t-title" width="50%"><b>周亏损金额</b></th>
            ...
            <div class="promo-content">
                ...
                <ol class="rules">
                    <li>周一至周日为一周期，凡是在【电子游艺厅】周累计负盈利达到对应等级，次周一早上8点即可在活动页面领取对应彩金。</li>
                    <li>该优惠按照达标的等级赠送一次，达标对应等级后便可在“优惠页面”点击领取，所获彩金仅需【三倍流水】即可取款。</li>
                    <li>请于次周一24点前领取彩金，逾期将无法领取该优惠。</li>
                    <li>
                        亏损金额为用户实际亏损金额 ( 需要减去在上周领取所有优惠彩金 )<br />
                        例：会员A 在电子-老虎机，负盈利金额为10000元，活动期间领取的优惠彩金为5000元，（10000-5000 = 5000），5000为用户的实际盈亏金额，可领取88元负盈利加赠彩金。
                    </li>
...
onMounted(() => {
    console.log('ff_promo_07', props.msg)
